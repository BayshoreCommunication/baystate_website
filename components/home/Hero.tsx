  ...
  return (
    <section className="w-full">
      ...
      <div className="bg-[#ffffff] text-center px-4 py-8 md:py-10">
        <h2 className="text-[20px] md:text-[48px]  font-semibold text-[#1a1a2e] leading-snug">
          We Plan with Purpose, and <br className="hidden md:block" />
          People in Mind.
        </h2>

        <p className="mt-4 text-sm md:text-[30px] max-w-[1320px] mx-auto text-[#000000] leading-relaxed">
